            ...
            switch (figura.getClass().getName()){//yo me acuerdo que así obtengo bien el nombre del hijo xD, sino revisa el KOnquest :v :C xD
                ...
                case "Cuadrado"://está listo
                    ...
                    canvas.drawRect((float)cuadrado.posicionInicialX, (float)cuadrado.posicionInicialY,
                            (float)cuadrado.posicionInicialY+(float)cuadrado.largo, (float)cuadrado.posicionInicialX+(float)cuadrado.ancho, pintor);//hice esto pues me debo asegurar, según el enunciado,
