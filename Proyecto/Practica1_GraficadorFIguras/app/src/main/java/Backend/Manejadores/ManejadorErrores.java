...
public class ManejadorErrores {//base terminada xD [es decir que puede tener cb pero ellos estarán basados en esta esructura...
    ...
    public void establecerError(String tipo, String nombreLexemAnterior, String nombreDelLexema,
        ...
        switch (tipo){
            case "Lexico":
                listaDeErrores.anadirAlPrincipio(new ReporteError(elLexema, numeroLinea, numeroColumna, tipo,
                        "Símbolo no aceptado"));
                break;
            case "Falta Tipo Figura":
                listaDeErrores.anadirAlPrincipio(new ReporteError(elLexema, numeroLinea, numeroColumna, "Sintáctico",//aquí el tipo era tipo xD[es decir lo que contenía esta var xD]
            ...
            case "error en 3 Parametros"://con este tipo de error, hasta me hace pensar en que no estaría mal si no hago las producciones estra para ser específica en el tipo de error sucedido es decir si no se llegó al valor#, al color/animación o al ")"
                listaDeErrores.anadirAlPrincipio(new ReporteError(elLexema, numeroLinea, numeroColumna, "Sintáctico",//Aquí y en los demás parám era "error en parámetros"
            ...
            case "error en 4 Parametros":
                listaDeErrores.anadirAlPrincipio(new ReporteError(elLexema, numeroLinea, numeroColumna, "Sintáctico",
            ...
            case "Operacion invalida"://u "operación errada"
                listaDeErrores.anadirAlPrincipio(new ReporteError(elLexema, numeroLinea, numeroColumna, "Sintáctico",//aquí era tipo xD
            ...
            case "error de instruccion"://Se dará una definición u otra dependiendo del lexema, pero para decir y acertar en lo dicho, que las instrucciones de animación solo deberían aparecer 1 vez abajo de la instrucc graficar se reuqeiría del anterior... para ver si es un ")"... creo xD
                listaDeErrores.anadirAlPrincipio(new ReporteError(elLexema, numeroLinea, numeroColumna, "Sintáctico",//y aquí tb lo de la var tipo xD
            ...
            case "division por cero":
                listaDeErrores.anadirAlPrincipio(new ReporteError(elLexema, numeroLinea, numeroColumna, "Sintáctico",//y aquí tb lo de la var tipo xD
                        "División por 0"));
                break;
        }//reemplace el método "añadirAlFInal" por el hecho de que CUP lee los errores desde el más reciente hasta el más antiguo, recuerda que esto solo lo hace cuando algo salió mal, de lo contrario todo lo procesará de forma normal, es decir del primero alúltimo y no al revés xD
    }
